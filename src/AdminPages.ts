...
function getAdminPage(cafeId: number | null, noticeMenuId: number | null, chatrooms: Record<string, string>, activeChatroom: Set<string>, chatbotApiToken: string, lastArticleTimestamp: number | null) {
    return `
<!doctype html>
<html>
...
export { authenticatePage, page401, getAdminPage };