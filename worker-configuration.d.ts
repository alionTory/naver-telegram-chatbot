/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a14bdc0e1f7a9db727ad2af139e9d70d)
// Runtime types generated with workerd@1.20260630.1 2024-09-23 nodejs_compat
interface __BaseEnv_Env {
	"kv-binding": KVNamespace;
	WORKER_APP_URL: "https://starrysouls-chatbot.nocurim67.workers.dev" | "https://gong2dl-chatbot.nocurim67.workers.dev" | "";
	ADMIN_PAGE_PASSWORD: string;
	CHATBOT_API_TOKEN: string;
	CHATBOT_WEBHOOK_TOKEN: string;
	CAFE_COOKIE_NID_AUT: string;
	CAFE_COOKIE_NID_SES: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface StarrysoulsEnv {
		"kv-binding": KVNamespace;
		WORKER_APP_URL: "https://starrysouls-chatbot.nocurim67.workers.dev";
		ADMIN_PAGE_PASSWORD: string;
		CHATBOT_API_TOKEN: string;
		CHATBOT_WEBHOOK_TOKEN: string;
		CAFE_COOKIE_NID_AUT: string;
	...
	interface Gong2dlEnv {
		"kv-binding": KVNamespace;
		WORKER_APP_URL: "https://gong2dl-chatbot.nocurim67.workers.dev";
		ADMIN_PAGE_PASSWORD: string;
		CHATBOT_API_TOKEN: string;
		CHATBOT_WEBHOOK_TOKEN: string;
		CAFE_COOKIE_NID_AUT: string;
